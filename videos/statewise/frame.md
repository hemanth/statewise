...
- **Fonts** — already set to **DM Sans** (display) / **DM Sans** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 450, 500, 550, 600, 650, 700, 750, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
